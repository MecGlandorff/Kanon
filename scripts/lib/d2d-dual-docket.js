...
const REPOSITORY_RULE_TEXT =
  /(?:```|diff --git|^\s*(?:\+{3}|-{3}|@@)|\b(?:patch|code edit|ready-to-paste|threshold|weight|candidate-[0-9a-f]|case-[0-9a-f]|django|react|cargo|rust|python|javascript|typescript|node(?:\.js)?|npm|pnpm|yarn|bun|monorepo|repository[- ]specific|framework[- ]specific)\b|[/\\]|\b\d+(?:\.\d+)?\s*(?:%|percent|percentage points)\b)/imu;
